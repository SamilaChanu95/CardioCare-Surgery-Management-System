 ...
 */
final class Version20200303040913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP terms_accepted');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD terms_accepted TINYINT(1) NOT NULL');
    }
}
