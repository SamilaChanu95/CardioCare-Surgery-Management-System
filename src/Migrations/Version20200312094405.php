 ...
 */
final class Version20200312094405 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surgery DROP name');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surgery ADD name VARCHAR(200) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
