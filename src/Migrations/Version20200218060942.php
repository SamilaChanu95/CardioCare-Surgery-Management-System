 ...
 */
final class Version20200218060942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE technician (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, unit_id INT NOT NULL, t_nic VARCHAR(50) NOT NULL, t_first_name VARCHAR(100) NOT NULL, t_last_name VARCHAR(100) NOT NULL, t_gender VARCHAR(50) NOT NULL, t_address VARCHAR(255) NOT NULL, t_dob VARCHAR(20) NOT NULL, t_phone_number VARCHAR(20) NOT NULL, INDEX IDX_F244E948AE80F5DF (department_id), INDEX IDX_F244E948F8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
