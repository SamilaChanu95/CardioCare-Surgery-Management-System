 ...
 */
final class Version20200320104037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB982FD978 FOREIGN KEY (patient_type_id) REFERENCES patient_type (id)');
