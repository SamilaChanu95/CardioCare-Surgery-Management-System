 ...
 */
final class Version20200420083229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE doctor CHANGE d_address d_address VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE nurse CHANGE n_address n_address VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE patient CHANGE p_first_name p_first_name VARCHAR(100) NOT NULL, CHANGE p_last_name p_last_name VARCHAR(100) NOT NULL, CHANGE p_medical_histroy p_medical_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_allergic_histroy p_allergic_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_surgical_histroy p_surgical_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_drug_histroy p_drug_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_social_histroy p_social_histroy VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE doctor CHANGE d_address d_address VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
