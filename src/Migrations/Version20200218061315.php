 ...
 */
final class Version20200218061315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE consultant (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, unit_id INT NOT NULL, c_nic VARCHAR(50) NOT NULL, c_first_name VARCHAR(100) NOT NULL, c_last_name VARCHAR(100) NOT NULL, c_gender VARCHAR(50) NOT NULL, c_address VARCHAR(255) NOT NULL, c_dob VARCHAR(50) NOT NULL, c_phone_number VARCHAR(20) NOT NULL, INDEX IDX_441282A1AE80F5DF (department_id), INDEX IDX_441282A1F8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
