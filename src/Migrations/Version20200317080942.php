 ...
 */
final class Version20200317080942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surgery ADD time TIME NOT NULL, ADD date DATE NOT NULL, DROP datetime');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE surgery ADD datetime DATETIME NOT NULL, DROP time, DROP date');
